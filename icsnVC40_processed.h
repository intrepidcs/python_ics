...
enum
{
  assert_line_3913 = 1 / (int)(!!(sizeof(CAN_SETTINGS) == 12))
};
;
enum
{
  assert_line_3914 = 1 / (int)(!!(sizeof(CANFD_SETTINGS) == 10))
};
;
enum
{
  assert_line_3915 = 1 / (int)(!!(sizeof(SWCAN_SETTINGS) == 14))
};
;
enum
{
  assert_line_3916 = 1 / (int)(!!(sizeof(LIN_SETTINGS) == 10))
};
;
enum
{
  assert_line_3917 = 1 / (int)(!!(sizeof(ISO9141_KEYWORD2000__INIT_STEP) == 6))
};
;
enum
{
  assert_line_3918 = 1 / (int)(!!(sizeof(ISO9141_KEYWORD2000_SETTINGS) == 114))
};
;
enum
{
  assert_line_3919 = 1 / (int)(!!(sizeof(UART_SETTINGS) == 16))
};
;
enum
{
  assert_line_3920 = 1 / (int)(!!(sizeof(J1708_SETTINGS) == 2))
};
;
enum
{
  assert_line_3921 = 1 / (int)(!!(sizeof(SRedSettings) == 44))
};
;
enum
{
  assert_line_3922 = 1 / (int)(!!(sizeof(STextAPISettings) == 72))
};
;
enum
{
  assert_line_3923 = 1 / (int)(!!(sizeof(stChipVersions) == 8))
};
;
enum
{
  assert_line_3924 = 1 / (int)(!!(sizeof(SNeoMostGatewaySettings) == 4))
};
;
enum
{
  assert_line_3925 = 1 / (int)(!!(sizeof(OP_ETH_GENERAL_SETTINGS) == 20))
};
;
enum
{
  assert_line_3926 = 1 / (int)(!!(sizeof(OP_ETH_SETTINGS) == 16))
};
;
enum
{
  assert_line_3927 = 1 / (int)(!!(sizeof(ETHERNET_SETTINGS) == 8))
};
;
enum
{
  assert_line_3928 = 1 / (int)(!!(sizeof(ETHERNET_SETTINGS2) == 16))
};
;
enum
{
  assert_line_3929 = 1 / (int)(!!(sizeof(ETHERNET10G_SETTINGS) == 24))
};
;
enum
{
  assert_line_3930 = 1 / (int)(!!(sizeof(LOGGER_SETTINGS) == 4))
};
;
enum
{
  assert_line_3931 = 1 / (int)(!!(sizeof(DISK_SETTINGS) == 14))
};
;
enum
{
  assert_line_3932 = 1 / (int)(!!(sizeof(SERDESCAM_SETTINGS) == 32))
};
;
enum
{
  assert_line_3933 = 1 / (int)(!!(sizeof(SERDESPOC_SETTINGS) == 10))
};
;
enum
{
  assert_line_3934 = 1 / (int)(!!(sizeof(RAD_REPORTING_SETTINGS) == 16))
};
;
enum
{
  assert_line_3935 = 1 / (int)(!!(sizeof(CANTERM_SETTINGS) == 6))
};
;
enum
{
  assert_line_3936 = 1 / (int)(!!(sizeof(SFireSettings) == 744))
};
;
enum
{
  assert_line_3937 = 1 / (int)(!!(sizeof(SFireVnetSettings) == 792))
};
;
enum
{
  assert_line_3938 = 1 / (int)(!!(sizeof(SCyanSettings) == 936))
};
;
enum
{
  assert_line_3939 = 1 / (int)(!!(sizeof(SVCAN3Settings) == 40))
};
;
enum
{
  assert_line_3940 = 1 / (int)(!!(sizeof(SVCAN4Settings) == 342))
};
;
enum
{
  assert_line_3941 = 1 / (int)(!!(sizeof(SVCANRFSettings) == 340))
};
;
enum
{
  assert_line_3942 = 1 / (int)(!!(sizeof(SECUSettings) == 470))
};
;
enum
{
  assert_line_3943 = 1 / (int)(!!(sizeof(SPendantSettings) == 470))
};
;
enum
{
  assert_line_3944 = 1 / (int)(!!(sizeof(SIEVBSettings) == 434))
};
;
enum
{
  assert_line_3945 = 1 / (int)(!!(sizeof(SEEVBSettings) == 32))
};
;
enum
{
  assert_line_3946 = 1 / (int)(!!(sizeof(SRADGalaxySettings) == 732))
};
;
enum
{
  assert_line_3947 = 1 / (int)(!!(sizeof(SRADStar2Settings) == 378))
};
;
enum
{
  assert_line_3948 = 1 / (int)(!!(sizeof(SOBD2SimSettings) == 148))
};
enum
{
  assert_line_3949 = 1 / (int)(!!(sizeof(CmProbeSettings) == 4))
};
;
enum
{
  assert_line_3950 = 1 / (int)(!!(sizeof(GLOBAL_SETTINGS) == (936 + 6)))
};
;
enum
{
  assert_line_3951 = 1 / (int)(!!(sizeof(stCM_ISO157652_TxMessage) == 4128))
};
;
enum
{
  assert_line_3952 = 1 / (int)(!!(sizeof(stCM_ISO157652_RxMessage) == 42))
};
;
enum
{
  assert_line_3953 = 1 / (int)(!!(sizeof(spyFilterLong) == 72))
};
;
enum
{
  assert_line_3954 = 1 / (int)(!!(sizeof(icsSpyMessage) == 72))
};
;
enum
{
  assert_line_3955 = 1 / (int)(!!(sizeof(icsSpyMessageLong) == 72))
};
;
enum
{
  assert_line_3956 = 1 / (int)(!!(sizeof(icsSpyMessageJ1850) == 72))
};
;
enum
{
  assert_line_3957 = 1 / (int)(!!(sizeof(icsSpyMessageVSB) == 64))
};
;
enum
{
  assert_line_3958 = 1 / (int)(!!(sizeof(OBD2ProSettings) == 482))
};
;
enum
{
  assert_line_3959 = 1 / (int)(!!(sizeof(ISO15765_2015_TxMessage) == (32 + sizeof(uint8_t*))))
};
;
enum
{
  assert_line_3960 = 1 / (int)(!!(sizeof(TIMESYNC_ICSHARDWARE_SETTINGS) == 4))
};
;
enum
{
  assert_line_3961 = 1 / (int)(!!(sizeof(SRADSuperMoonSettings) == 142))
};
;
enum
{
  assert_line_3962 = 1 / (int)(!!(sizeof(SRADMoon2Settings) == 126))
};
;
enum
{
  assert_line_3963 = 1 / (int)(!!(sizeof(SRADGigalogSettings) == 666))
};
;
enum
{
  assert_line_3964 = 1 / (int)(!!(sizeof(SRADGigastarSettings) == 634))
};
;
enum
{
  assert_line_3965 = 1 / (int)(!!(sizeof(SExtSubCmdHdr) == 4))
};
;
enum
{
  assert_line_3966 = 1 / (int)(!!(sizeof(SDiskStructure) == 16))
};
;
enum
{
  assert_line_3967 = 1 / (int)(!!(sizeof(SDiskFormatProgress) == 10))
};
;
enum
{
  assert_line_3968 = 1 / (int)(!!(sizeof(SDiskStatus) == 14))
};
;
enum
{
  assert_line_3969 = 1 / (int)(!!(sizeof(SExtSubCmdComm) == 188))
};
;
enum
{
  assert_line_3970 = 1 / (int)(!!(sizeof(SRADPlutoSettings) == 348))
};
;
enum
{
  assert_line_3971 = 1 / (int)(!!(sizeof(CANHubSettings) == 52))
};
;
enum
{
  assert_line_3972 = 1 / (int)(!!(sizeof(SNeoECU12Settings) == 350))
};
;
enum
{
  assert_line_3973 = 1 / (int)(!!(sizeof(SPlutoSwitchSettings) == 50378))
};
;
enum
{
  assert_line_3974 = 1 / (int)(!!(sizeof(VCAN4IndSettings) == (228)))
};
;
enum
{
  assert_line_3975 = 1 / (int)(!!(sizeof(SRADJupiterSettings) == 332))
};
;
enum
{
  assert_line_3976 = 1 / (int)(!!(sizeof(RadMoonDuoSettings) == 38))
};
;
enum
{
  assert_line_3977 = 1 / (int)(!!(sizeof(SFire3Settings) == (600)))
};
;
enum
{
  assert_line_3978 = 1 / (int)(!!(sizeof(SEtherBadgeSettings) == 316))
};
;
