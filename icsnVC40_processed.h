...
enum { assert_line_3888 = 1 / (int)(!!(sizeof(CAN_SETTINGS) == 12)) };;
enum { assert_line_3889 = 1 / (int)(!!(sizeof(CANFD_SETTINGS) == 10)) };;
enum { assert_line_3890 = 1 / (int)(!!(sizeof(SWCAN_SETTINGS) == 14)) };;
enum { assert_line_3891 = 1 / (int)(!!(sizeof(LIN_SETTINGS) == 10)) };;
enum { assert_line_3892 = 1 / (int)(!!(sizeof(ISO9141_KEYWORD2000__INIT_STEP) == 6)) };;
enum { assert_line_3893 = 1 / (int)(!!(sizeof(ISO9141_KEYWORD2000_SETTINGS) == 114)) };;
enum { assert_line_3894 = 1 / (int)(!!(sizeof(UART_SETTINGS) == 16)) };;
enum { assert_line_3895 = 1 / (int)(!!(sizeof(J1708_SETTINGS) == 2)) };;
enum { assert_line_3896 = 1 / (int)(!!(sizeof(SRedSettings) == 44)) };;
enum { assert_line_3897 = 1 / (int)(!!(sizeof(STextAPISettings) == 72)) };;
enum { assert_line_3898 = 1 / (int)(!!(sizeof(stChipVersions) == 8)) };;
enum { assert_line_3899 = 1 / (int)(!!(sizeof(SNeoMostGatewaySettings) == 4)) };;
enum { assert_line_3900 = 1 / (int)(!!(sizeof(OP_ETH_GENERAL_SETTINGS) == 20)) };;
enum { assert_line_3901 = 1 / (int)(!!(sizeof(OP_ETH_SETTINGS) == 16)) };;
enum { assert_line_3902 = 1 / (int)(!!(sizeof(ETHERNET_SETTINGS) == 8)) };;
enum { assert_line_3903 = 1 / (int)(!!(sizeof(ETHERNET_SETTINGS2) == 16)) };;
enum { assert_line_3904 = 1 / (int)(!!(sizeof(ETHERNET10G_SETTINGS) == 24)) };;
enum { assert_line_3905 = 1 / (int)(!!(sizeof(LOGGER_SETTINGS) == 4)) };;
enum { assert_line_3906 = 1 / (int)(!!(sizeof(DISK_SETTINGS) == 14)) };;
enum { assert_line_3907 = 1 / (int)(!!(sizeof(SERDESCAM_SETTINGS) == 32)) };;
enum { assert_line_3908 = 1 / (int)(!!(sizeof(SERDESPOC_SETTINGS) == 10)) };;
enum { assert_line_3909 = 1 / (int)(!!(sizeof(RAD_REPORTING_SETTINGS) == 16)) };;
enum { assert_line_3910 = 1 / (int)(!!(sizeof(CANTERM_SETTINGS) == 6)) };;
enum { assert_line_3911 = 1 / (int)(!!(sizeof(SFireSettings) == 744)) };;
enum { assert_line_3912 = 1 / (int)(!!(sizeof(SFireVnetSettings) == 792)) };;
enum { assert_line_3913 = 1 / (int)(!!(sizeof(SCyanSettings) == 920)) };;
enum { assert_line_3914 = 1 / (int)(!!(sizeof(SVCAN3Settings) == 40)) };;
enum { assert_line_3915 = 1 / (int)(!!(sizeof(SVCAN4Settings) == 326)) };;
enum { assert_line_3916 = 1 / (int)(!!(sizeof(SVCANRFSettings) == 340)) };;
enum { assert_line_3917 = 1 / (int)(!!(sizeof(SECUSettings) == 470)) };;
enum { assert_line_3918 = 1 / (int)(!!(sizeof(SPendantSettings) == 470)) };;
enum { assert_line_3919 = 1 / (int)(!!(sizeof(SIEVBSettings) == 434)) };;
enum { assert_line_3920 = 1 / (int)(!!(sizeof(SEEVBSettings) == 32)) };;
enum { assert_line_3921 = 1 / (int)(!!(sizeof(SRADGalaxySettings) == 698)) };;
enum { assert_line_3922 = 1 / (int)(!!(sizeof(SRADStar2Settings) == 362)) };;
enum { assert_line_3923 = 1 / (int)(!!(sizeof(SOBD2SimSettings) == 148)) };
enum { assert_line_3924 = 1 / (int)(!!(sizeof(CmProbeSettings) == 4)) };;
enum { assert_line_3925 = 1 / (int)(!!(sizeof(GLOBAL_SETTINGS) == (920 + 6))) };;
enum { assert_line_3926 = 1 / (int)(!!(sizeof(stCM_ISO157652_TxMessage) == 4128)) };;
enum { assert_line_3927 = 1 / (int)(!!(sizeof(stCM_ISO157652_RxMessage) == 42)) };;
enum { assert_line_3928 = 1 / (int)(!!(sizeof(spyFilterLong) == 72)) };;
enum { assert_line_3929 = 1 / (int)(!!(sizeof(icsSpyMessage) == 72)) };;
enum { assert_line_3930 = 1 / (int)(!!(sizeof(icsSpyMessageLong) == 72)) };;
enum { assert_line_3931 = 1 / (int)(!!(sizeof(icsSpyMessageJ1850) == 72)) };;
enum { assert_line_3932 = 1 / (int)(!!(sizeof(icsSpyMessageVSB) == 64)) };;
enum { assert_line_3933 = 1 / (int)(!!(sizeof(OBD2ProSettings) == 464)) };;
enum { assert_line_3934 = 1 / (int)(!!(sizeof(ISO15765_2015_TxMessage) == (32 + sizeof(uint8_t *)))) };;
enum { assert_line_3935 = 1 / (int)(!!(sizeof(TIMESYNC_ICSHARDWARE_SETTINGS) == 4)) };;
enum { assert_line_3936 = 1 / (int)(!!(sizeof(SRADSuperMoonSettings) == 142)) };;
enum { assert_line_3937 = 1 / (int)(!!(sizeof(SRADMoon2Settings) == 126)) };;
enum { assert_line_3938 = 1 / (int)(!!(sizeof(SRADGigalogSettings) == 666)) };;
enum { assert_line_3939 = 1 / (int)(!!(sizeof(SRADGigastarSettings) == 634)) };;
enum { assert_line_3940 = 1 / (int)(!!(sizeof(SExtSubCmdHdr) == 4)) };;
enum { assert_line_3941 = 1 / (int)(!!(sizeof(SDiskStructure) == 16)) };;
enum { assert_line_3942 = 1 / (int)(!!(sizeof(SDiskFormatProgress) == 10)) };;
enum { assert_line_3943 = 1 / (int)(!!(sizeof(SDiskStatus) == 14)) };;
enum { assert_line_3944 = 1 / (int)(!!(sizeof(SExtSubCmdComm) == 188)) };;
enum { assert_line_3945 = 1 / (int)(!!(sizeof(SRADPlutoSettings) == 306)) };;
enum { assert_line_3946 = 1 / (int)(!!(sizeof(CANHubSettings) == 52)) };;
enum { assert_line_3947 = 1 / (int)(!!(sizeof(SNeoECU12Settings) == 350)) };;
enum { assert_line_3948 = 1 / (int)(!!(sizeof(SPlutoSwitchSettings) == 50378)) };;
enum { assert_line_3949 = 1 / (int)(!!(sizeof(VCAN4IndSettings) == (212))) };;
enum { assert_line_3950 = 1 / (int)(!!(sizeof(SRADJupiterSettings) == 316)) };;
enum { assert_line_3951 = 1 / (int)(!!(sizeof(RadMoonDuoSettings) == 38)) };;
enum { assert_line_3952 = 1 / (int)(!!(sizeof(SFire3Settings) == (584))) };;
