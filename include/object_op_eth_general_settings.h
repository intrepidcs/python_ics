...
static PyMemberDef op_eth_general_settings_object_members[] = {
    ...
    { "tapPair0", T_USHORT, offsetof(op_eth_general_settings_object, s.tapPair0), 0, ""},
    { "tapPair1", T_USHORT, offsetof(op_eth_general_settings_object, s.tapPair1), 0, ""},
    { "tapPair2", T_USHORT, offsetof(op_eth_general_settings_object, s.tapPair2), 0, ""},
    { "tapPair3", T_USHORT, offsetof(op_eth_general_settings_object, s.tapPair3), 0, ""},
    { "tapPair4", T_USHORT, offsetof(op_eth_general_settings_object, s.tapPair4), 0, ""},
    { "tapPair5", T_USHORT, offsetof(op_eth_general_settings_object, s.tapPair5), 0, ""},
