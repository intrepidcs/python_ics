...
class Nameless19434(ctypes.Structure):
    _pack_ = 2
    _fields_ = [
...
class Nameless28447(ctypes.Union):
    _pack_ = 2
    _anonymous_  = ('Nameless19434',)
    _fields_ = [
        ('bOptions', ctypes.c_uint32),
        ('Nameless19434', Nameless19434),
    ]
