...
class nameless4706(ctypes.Structure):
    _fields_ = [
...
class nameless50071(ctypes.Union):
    _anonymous_  = ('nameless4706',)
    _fields_ = [
        ('nameless4706', nameless4706),
