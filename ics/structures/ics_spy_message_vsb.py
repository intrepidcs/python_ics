...
class Nameless36865(ctypes.Structure):
    _fields_ = [
...
class Nameless48434(ctypes.Union):
    _anonymous_  = ('Nameless36865',)
    _fields_ = [
        ('Nameless36865', Nameless36865),
