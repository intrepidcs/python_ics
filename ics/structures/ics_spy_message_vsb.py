...
class nameless59574(ctypes.Structure):
    _fields_ = [
...
class nameless34109(ctypes.Union):
    _anonymous_  = ('nameless59574',)
    _fields_ = [
        ('nameless59574', nameless59574),
