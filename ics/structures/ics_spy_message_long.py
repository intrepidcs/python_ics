...
class Nameless24324(ctypes.Structure):
    _fields_ = [
...
class Nameless52495(ctypes.Union):
    _anonymous_  = ('Nameless24324',)
    _fields_ = [
        ('Nameless24324', Nameless24324),
