...
class nameless52444(ctypes.Structure):
    _fields_ = [
...
class nameless48243(ctypes.Union):
    _anonymous_  = ('nameless52444',)
    _fields_ = [
        ('nameless52444', nameless52444),
