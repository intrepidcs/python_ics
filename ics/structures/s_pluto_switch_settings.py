...
class s_pluto_switch_settings(ctypes.Structure):
    _pack_ = 2
    _fields_ = [
        ('flashHeader', s_extended_data_flash_header), # all extended data must start with this header
...
# Extra names go here:
SPlutoSwitchSettings = s_pluto_switch_settings
# End of extra names
