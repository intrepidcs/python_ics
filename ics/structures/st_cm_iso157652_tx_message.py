...
class nameless55527(ctypes.Structure):
    _pack_ = 2
    _fields_ = [
...
class nameless33784(ctypes.Union):
    _pack_ = 2
    _anonymous_  = ('nameless55527',)
    _fields_ = [
        ('nameless55527', nameless55527),
