...
class nameless63659(ctypes.Structure):
    _pack_ = 2
    _fields_ = [
...
class nameless43868(ctypes.Union):
    _pack_ = 2
    _anonymous_  = ('nameless63659',)
    _fields_ = [
        ('nameless63659', nameless63659),
