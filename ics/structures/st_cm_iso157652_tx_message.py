...
class nameless10786(ctypes.Structure):
    _pack_ = 2
    _fields_ = [
...
class nameless15193(ctypes.Union):
    _pack_ = 2
    _anonymous_  = ('nameless10786',)
    _fields_ = [
        ('nameless10786', nameless10786),
