...
class Nameless57744(ctypes.Structure):
    _pack_ = 2
    _fields_ = [
...
class Nameless30473(ctypes.Union):
    _pack_ = 2
    _anonymous_  = ('Nameless57744',)
    _fields_ = [
        ('Nameless57744', Nameless57744),
