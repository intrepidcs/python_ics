...
class nameless55606(ctypes.Structure):
    _pack_ = 2
    _fields_ = [
...
class nameless227(ctypes.Union):
    _pack_ = 2
    _anonymous_  = ('nameless55606',)
    _fields_ = [
        ('nameless55606', nameless55606),
