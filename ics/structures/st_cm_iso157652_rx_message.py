...
class nameless63912(ctypes.Structure):
    _pack_ = 2
    _fields_ = [
...
class nameless44199(ctypes.Union):
    _pack_ = 2
    _anonymous_  = ('nameless63912',)
    _fields_ = [
        ('nameless63912', nameless63912),
