...
class nameless55083(ctypes.Structure):
    _pack_ = 2
    _fields_ = [
...
class nameless16918(ctypes.Union):
    _pack_ = 2
    _anonymous_  = ('nameless55083',)
    _fields_ = [
        ('nameless55083', nameless55083),
