...
class Nameless64290(ctypes.Structure):
    _pack_ = 2
    _fields_ = [
...
class Nameless21668(ctypes.Union):
    _pack_ = 2
    _anonymous_  = ('Nameless64290',)
    _fields_ = [
        ('Nameless64290', Nameless64290),
