...
class nameless5185(ctypes.Structure):
    _pack_ = 2
    _fields_ = [
...
class nameless22325(ctypes.Union):
    _pack_ = 2
    _anonymous_  = ('nameless5185',)
    _fields_ = [
        ('nameless5185', nameless5185),
