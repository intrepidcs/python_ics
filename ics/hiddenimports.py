hidden_imports = [
    ...
    "ics.structures.manufacturing_operation_params",
    "ics.structures.s_reflash_chip_t",
    "ics.structures.s_performance_stats",
    "ics.structures.can_settings_decode",
    "ics.structures.s_neo_most_gateway_settings_decode",
    "ics.structures.s_reflash_request",
    "ics.structures.ics_spy_message_gps",
    "ics.structures.ics_spy_message_analog",
    "ics.structures.ics_spy_msg_time",
    "ics.structures.spy_filter_bytes",
    "ics.structures.ics_spy_time",
    "ics.structures.bootloader_extended_pars_t",
    "ics.structures.bootloader_pars_t",
    ...
    "ics.structures.ext_comm_subcommand",
    "ics.structures.manufacturing_error_type",
    "ics.structures.can_clock_t",
    "ics.structures.can_clock_fire2_t",
]
